...
class turret_gen_class:
    '''!
    Class that helps perform the turret process.
    '''
    def __init__(self, task_name):
        '''!
        Initializes an instance of the turret generator class. This 
        initialization creates instances of all objects necessary for the 
        turret process.
